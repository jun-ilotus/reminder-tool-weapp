...
type Lottery struct {
	...
	JoinNumber    int64                  `protobuf:"varint,6,opt,name=joinNumber,proto3" json:"joinNumber,omitempty"`       //鑷姩寮€濂栦汉鏁?  string introduce = 7; //鎶藉璇存槑
	AwardDeadline int64                  `protobuf:"varint,8,opt,name=awardDeadline,proto3" json:"awardDeadline,omitempty"` //棰嗗鎴鏃堕棿
	IsSelected    int64                  `protobuf:"varint,9,opt,name=isSelected,proto3" json:"isSelected,omitempty"`       //鏄惁绮鹃€?1鏄?0鍚?  int64 announceType = 10; //寮€濂栬缃細1鎸夋椂闂村紑濂?2鎸変汉鏁板紑濂?3鍗虫娊鍗充腑
	AnnounceTime  int64                  `protobuf:"varint,11,opt,name=announceTime,proto3" json:"announceTime,omitempty"`  //寮€濂栨椂闂?  int64 createTime = 12; //createTime
	UpdateTime    int64                  `protobuf:"varint,13,opt,name=updateTime,proto3" json:"updateTime,omitempty"`      //updateTime
	IsAnnounced   int64                  `protobuf:"varint,14,opt,name=isAnnounced,proto3" json:"isAnnounced,omitempty"`    //鏄惁寮€濂栵細0鏈紑濂栵紱1宸茬粡寮€濂?  int64 sponsorId = 15; //鍙戣捣鎶藉璧炲姪鍟咺D
	IsClocked     int64                  `protobuf:"varint,16,opt,name=isClocked,proto3" json:"isClocked,omitempty"`        //鏄惁寮€鍚墦鍗′换鍔★細0鏈紑鍚紱1宸插紑鍚?  int64 clockTaskId = 17; //鎵撳崱浠诲姟浠诲姟ID
...
type AddLotteryReq struct {
	...
	JoinNumber    int64                  `protobuf:"varint,5,opt,name=joinNumber,proto3" json:"joinNumber,omitempty"`       //鑷姩寮€濂栦汉鏁?  string introduce = 6; //鎶藉璇存槑
	AwardDeadline int64                  `protobuf:"varint,7,opt,name=awardDeadline,proto3" json:"awardDeadline,omitempty"` //棰嗗鎴鏃堕棿
	IsSelected    int64                  `protobuf:"varint,8,opt,name=isSelected,proto3" json:"isSelected,omitempty"`       //鏄惁绮鹃€?1鏄?0鍚?  int64 announceType = 9; //寮€濂栬缃細1鎸夋椂闂村紑濂?2鎸変汉鏁板紑濂?3鍗虫娊鍗充腑
	AnnounceTime  int64                  `protobuf:"varint,10,opt,name=announceTime,proto3" json:"announceTime,omitempty"`  //寮€濂栨椂闂?  int64 isAnnounced = 11; //鏄惁寮€濂栵細0鏈紑濂栵紱1宸茬粡寮€濂?  int64 sponsorId = 12; //鍙戣捣鎶藉璧炲姪鍟咺D
	IsClocked     int64                  `protobuf:"varint,13,opt,name=isClocked,proto3" json:"isClocked,omitempty"`        //鏄惁寮€鍚墦鍗′换鍔★細0鏈紑鍚紱1宸插紑鍚?  int64 clockTaskId = 14; //鎵撳崱浠诲姟浠诲姟ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type UpdateLotteryReq struct {
	...
	AwardDeadline int64                  `protobuf:"varint,8,opt,name=awardDeadline,proto3" json:"awardDeadline,omitempty"` //棰嗗鎴鏃堕棿
	IsSelected    int64                  `protobuf:"varint,9,opt,name=isSelected,proto3" json:"isSelected,omitempty"`       //鏄惁绮鹃€?1鏄?0鍚?  int64 announceType = 10; //寮€濂栬缃細1鎸夋椂闂村紑濂?2鎸変汉鏁板紑濂?3鍗虫娊鍗充腑
	AnnounceTime  int64                  `protobuf:"varint,11,opt,name=announceTime,proto3" json:"announceTime,omitempty"`  //寮€濂栨椂闂?  int64 isAnnounced = 12; //鏄惁寮€濂栵細0鏈紑濂栵紱1宸茬粡寮€濂?  int64 sponsorId = 13; //鍙戣捣鎶藉璧炲姪鍟咺D
	IsClocked     int64                  `protobuf:"varint,14,opt,name=isClocked,proto3" json:"isClocked,omitempty"`        //鏄惁寮€鍚墦鍗′换鍔★細0鏈紑鍚紱1宸插紑鍚?  int64 clockTaskId = 15; //鎵撳崱浠诲姟浠诲姟ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SearchLotteryReq struct {
	...
	JoinNumber    int64                  `protobuf:"varint,8,opt,name=joinNumber,proto3" json:"joinNumber,omitempty"`        //鑷姩寮€濂栦汉鏁?  string introduce = 9; //鎶藉璇存槑
	AwardDeadline int64                  `protobuf:"varint,10,opt,name=awardDeadline,proto3" json:"awardDeadline,omitempty"` //棰嗗鎴鏃堕棿
	IsSelected    int64                  `protobuf:"varint,11,opt,name=isSelected,proto3" json:"isSelected,omitempty"`       //鏄惁绮鹃€?1鏄?0鍚?  int64 announceType = 12; //寮€濂栬缃細1鎸夋椂闂村紑濂?2鎸変汉鏁板紑濂?3鍗虫娊鍗充腑
	AnnounceTime  int64                  `protobuf:"varint,13,opt,name=announceTime,proto3" json:"announceTime,omitempty"`   //寮€濂栨椂闂?  int64 createTime = 14; //createTime
	UpdateTime    int64                  `protobuf:"varint,15,opt,name=updateTime,proto3" json:"updateTime,omitempty"`       //updateTime
	IsAnnounced   int64                  `protobuf:"varint,16,opt,name=isAnnounced,proto3" json:"isAnnounced,omitempty"`     //鏄惁寮€濂栵細0鏈紑濂栵紱1宸茬粡寮€濂?  int64 sponsorId = 17; //鍙戣捣鎶藉璧炲姪鍟咺D
	IsClocked     int64                  `protobuf:"varint,18,opt,name=isClocked,proto3" json:"isClocked,omitempty"`         //鏄惁寮€鍚墦鍗′换鍔★細0鏈紑鍚紱1宸插紑鍚?  int64 clockTaskId = 19; //鎵撳崱浠诲姟浠诲姟ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type LotteryParticipation struct {
	...
	IsWon         int64                  `protobuf:"varint,4,opt,name=isWon,proto3" json:"isWon,omitempty"`           //涓浜嗗悧锛?  int64 prizeId = 5; //濂栧搧id
...
type AddLotteryParticipationReq struct {
	...
	IsWon         int64                  `protobuf:"varint,3,opt,name=isWon,proto3" json:"isWon,omitempty"`         //涓浜嗗悧锛?  int64 prizeId = 4; //濂栧搧id
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SearchLotteryParticipationReq struct {
	...
	IsWon         int64                  `protobuf:"varint,6,opt,name=isWon,proto3" json:"isWon,omitempty"`           //涓浜嗗悧锛?  int64 prizeId = 7; //濂栧搧id
...
func (x *SearchLotteryParticipationReq) GetPage() int64 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *SearchLotteryParticipationReq) GetLimit() int64 {
	if x != nil {
		return x.Limit
	}
	return 0
...
type Prize struct {
	...
	Thumb         string                 `protobuf:"bytes,6,opt,name=thumb,proto3" json:"thumb,omitempty"`             //濂栧搧鍥?  int64 count = 7; //濂栧搧浠芥暟
...
type AddPrizeReq struct {
	...
	Thumb         string                 `protobuf:"bytes,5,opt,name=thumb,proto3" json:"thumb,omitempty"`          //濂栧搧鍥?  int64 count = 6; //濂栧搧浠芥暟
...
type SearchPrizeReq struct {
	...
	Thumb         string                 `protobuf:"bytes,8,opt,name=thumb,proto3" json:"thumb,omitempty"`             //濂栧搧鍥?  int64 count = 9; //濂栧搧浠芥暟
...
var file_lottery_proto_rawDesc = string([]byte{
	...
	0x02, 0x70, 0x62, 0x22, 0xe7, 0x02, 0x0a, 0x07, 0x4c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x12,
	...
	0x62, 0x65, 0x72, 0x12, 0x24, 0x0a, 0x0d, 0x61, 0x77, 0x61, 0x72, 0x64, 0x44, 0x65, 0x61, 0x64,
	...
	0x6f, 0x75, 0x6e, 0x63, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x0c, 0x61, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x1e, 0x0a,
	...
	0x0b, 0x69, 0x73, 0x41, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x64, 0x18, 0x0e, 0x20, 0x01,
	...
	0x28, 0x03, 0x52, 0x09, 0x69, 0x73, 0x43, 0x6c, 0x6f, 0x63, 0x6b, 0x65, 0x64, 0x22, 0x9b, 0x02,
	0x0a, 0x0d, 0x41, 0x64, 0x64, 0x4c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x52, 0x65, 0x71, 0x12,
	...
	0x62, 0x12, 0x20, 0x0a, 0x0b, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x54, 0x69, 0x6d, 0x65,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x54,
	0x69, 0x6d, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x6a, 0x6f, 0x69, 0x6e, 0x4e, 0x75, 0x6d, 0x62, 0x65,
	0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x6a, 0x6f, 0x69, 0x6e, 0x4e, 0x75, 0x6d,
	0x62, 0x65, 0x72, 0x12, 0x24, 0x0a, 0x0d, 0x61, 0x77, 0x61, 0x72, 0x64, 0x44, 0x65, 0x61, 0x64,
	...
	0x73, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x65, 0x64, 0x12, 0x22, 0x0a, 0x0c, 0x61, 0x6e, 0x6e,
	0x6f, 0x75, 0x6e, 0x63, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x0c, 0x61, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x1c, 0x0a,
	0x09, 0x69, 0x73, 0x43, 0x6c, 0x6f, 0x63, 0x6b, 0x65, 0x64, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x09, 0x69, 0x73, 0x43, 0x6c, 0x6f, 0x63, 0x6b, 0x65, 0x64, 0x22, 0x10, 0x0a, 0x0e, 0x41,
	0x64, 0x64, 0x4c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x22, 0xae, 0x02,
	...
	,
	...
	0x70, 0x12, 0x25, 0x0a, 0x07, 0x6c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x18, 0x01, 0x20, 0x01,
	0x28, 0
 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x12, 0x2d, 0x0a, 0x08, 0x41,
...
var file_lottery_proto_goTypes = []any{
	...
	(*Prize)(nil),                           // 22: pb.Prize
	(*AddPrizeReq)(nil),                     // 23: pb.AddPrizeReq
	(*AddPrizeResp)(nil),                    // 24: pb.AddPrizeResp
	(*UpdatePrizeReq)(nil),                  // 25: pb.UpdatePrizeReq
	(*UpdatePrizeResp)(nil),                 // 26: pb.UpdatePrizeResp
	(*DelPrizeReq)(nil),                     // 27: pb.DelPrizeReq
	(*DelPrizeResp)(nil),                    // 28: pb.DelPrizeResp
	(*GetPrizeByIdReq)(nil),                 // 29: pb.GetPrizeByIdReq
	(*GetPrizeByIdResp)(nil),                // 30: pb.GetPrizeByIdResp
	(*SearchPrizeReq)(nil),                  // 31: pb.SearchPrizeReq
	(*SearchPrizeResp)(nil),                 // 32: pb.SearchPrizeResp
}
var file_lottery_proto_depIdxs = []int32{
	...
	22, // 4: pb.GetPrizeByIdResp.prize:type_name -> pb.Prize
	22, // 5: pb.SearchPrizeResp.prize:type_name -> pb.Prize
	...
	12, // 11: pb.lottery.AddLotteryParticipation:input_type -> pb.AddLotteryParticipationReq
	14, // 12: pb.lottery.UpdateLotteryParticipation:input_type -> pb.UpdateLotteryParticipationReq
	16, // 13: pb.lottery.DelLotteryParticipation:input_type -> pb.DelLotteryParticipationReq
	18, // 14: pb.lottery.GetLotteryParticipationById:input_type -> pb.GetLotteryParticipationByIdReq
	20, // 15: pb.lottery.SearchLotteryParticipation:input_type -> pb.SearchLotteryParticipationReq
	23, // 16: pb.lottery.AddPrize:input_type -> pb.AddPrizeReq
	25, // 17: pb.lottery.UpdatePrize:input_type -> pb.UpdatePrizeReq
	27, // 18: pb.lottery.DelPrize:input_type -> pb.DelPrizeReq
	29, // 19: pb.lottery.GetPrizeById:input_type -> pb.GetPrizeByIdReq
	31, // 20: pb.lottery.SearchPrize:input_type -> pb.SearchPrizeReq
	2,  // 21: pb.lottery.AddLottery:output_type -> pb.AddLotteryResp
	4,  // 22: pb.lottery.UpdateLottery:output_type -> pb.UpdateLotteryResp
	6,  // 23: pb.lottery.DelLottery:output_type -> pb.DelLotteryResp
	8,  // 24: pb.lottery.GetLotteryById:output_type -> pb.GetLotteryByIdResp
	10, // 25: pb.lottery.SearchLottery:output_type -> pb.SearchLotteryResp
	13, // 26: pb.lottery.AddLotteryParticipation:output_type -> pb.AddLotteryParticipationResp
	15, // 27: pb.lottery.UpdateLotteryParticipation:output_type -> pb.UpdateLotteryParticipationResp
	17, // 28: pb.lottery.DelLotteryParticipation:output_type -> pb.DelLotteryParticipationResp
	19, // 29: pb.lottery.GetLotteryParticipationById:output_type -> pb.GetLotteryParticipationByIdResp
	21, // 30: pb.lottery.SearchLotteryParticipation:output_type -> pb.SearchLotteryParticipationResp
	24, // 31: pb.lottery.AddPrize:output_type -> pb.AddPrizeResp
	26, // 32: pb.lottery.UpdatePrize:output_type -> pb.UpdatePrizeResp
	28, // 33: pb.lottery.DelPrize:output_type -> pb.DelPrizeResp
	30, // 34: pb.lottery.GetPrizeById:output_type -> pb.GetPrizeByIdResp
	32, // 35: pb.lottery.SearchPrize:output_type -> pb.SearchPrizeResp
